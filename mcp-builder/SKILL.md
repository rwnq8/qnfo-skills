...
`skill_view('mcp-builder')` or `read()` with filesystem path.
...
update_plan([
  {"step": "Define MCP server tools and resources", "status": "pending"},
  {"step": "Implement tool handlers (Python FastMCP or Node/TypeScript)", "status": "pending"},
  {"step": "Configure server for transport", "status": "pending"},
  {"step": "Test all tools with sample inputs", "status": "pending"},
  {"step": "Deploy and verify server connects", "status": "pending"}
])
