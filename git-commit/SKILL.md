...
update_plan([
  {"step": "Review staged/unstaged changes", "status": "pending"},
  {"step": "Generate conventional commit message", "status": "pending"},
  {"step": "Verify commit message format", "status": "pending"},
  {"step": "Commit with verification", "status": "pending"}
])
