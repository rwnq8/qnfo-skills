...
`skill_view('xlsx')` or `read()` with filesystem path.
...
update_plan([
  {"step": "Create or open spreadsheet", "status": "pending"},
  {"step": "Add data, formulas, and formatting", "status": "pending"},
  {"step": "Run data analysis and visualization", "status": "pending"},
  {"step": "Recalculate and verify formulas", "status": "pending"}
])
