...
update_plan([
  {"step": "Select infographic template type", "status": "pending"},
  {"step": "Structure input data for template", "status": "pending"},
  {"step": "Configure theme and visual settings", "status": "pending"},
  {"step": "Generate AntV Infographic DSL output", "status": "pending"},
  {"step": "Verify output renders correctly", "status": "pending"}
])
