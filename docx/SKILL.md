...
`skill_view('docx')` or `read()` with filesystem path.
...
update_plan([
  {"step": "Create or open .docx document", "status": "pending"},
  {"step": "Add/modify content with formatting", "status": "pending"},
  {"step": "Handle tracked changes and comments", "status": "pending"},
  {"step": "Save and verify document integrity", "status": "pending"}
])
