...
update_plan([
  {"step": "Open or create PDF document", "status": "pending"},
  {"step": "Extract, merge, split, or fill forms", "status": "pending"},
  {"step": "Verify output integrity", "status": "pending"},
  {"step": "Save and verify PDF", "status": "pending"}
])
