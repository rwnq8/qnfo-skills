...
update_plan([
  {"step": "Gather context and requirements from user", "status": "pending"},
  {"step": "Draft structured outline", "status": "pending"},
  {"step": "Iterate on content through review cycles", "status": "pending"},
  {"step": "Verify document works for intended readers", "status": "pending"},
  {"step": "Finalize and export", "status": "pending"}
])
