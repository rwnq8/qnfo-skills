...
`skill_view('skill-creator')` or `read()` with filesystem path.
...
update_plan([
  {"step": "Define skill purpose and trigger patterns", "status": "pending"},
  {"step": "Create SKILL.md with required sections", "status": "pending"},
  {"step": "Define execute_plan and Related: header", "status": "pending"},
  {"step": "Add embedded scripts and protocols", "status": "pending"},
  {"step": "Deploy and verify skill loads correctly", "status": "pending"}
])
